...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/27 02:44:17 by reldahli          #+#    #+#             */
/*   Updated: 2025/07/27 02:44:19 by reldahli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() {
	...
	std::cout << GREEN << "ClapTrap " << this->_name << " is constructed!" << RESET << std::endl;
}
...
ClapTrap::ClapTrap(const ClapTrap& other) {
	...
	std::cout << GREEN << "ClapTrap " << this->_name << " is copy constructed!" << RESET << std::endl;
}
...
void ClapTrap::attack(const std::string& target) {
	if (this->_hitPoints == 0 || this->_energyPoints == 0) {
		std::cout << RED << "ClapTrap " << this->_name << " can't attack!" << RESET << std::endl;
		return;
	}
	this->_energyPoints--;
